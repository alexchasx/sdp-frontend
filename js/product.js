...
const toggleModalBuy = () => {
  ...
  (0,_functions__WEBPACK_IMPORTED_MODULE_1__.toggleModal)(modalBuy, openBtnBuy, closeBtnBuy);
};
const toggleModalThinks = () => {
  ...
  (0,_functions__WEBPACK_IMPORTED_MODULE_1__.toggleModal)(modalThinks, openBtnThinks, closeBtnThinks, showCallback);
};
const toggleModalImage = () => {
  ...
  (0,_functions__WEBPACK_IMPORTED_MODULE_1__.toggleModal)(modalImage, openImage, closeBtnImage);
};
const validateForm = () => {
  const productForm = document.querySelector('#product-form');
  if (productForm) {
    const validation = new just_validate__WEBPACK_IMPORTED_MODULE_2__["default"](productForm);
    validation.addField('#product-name', [{
      rule: 'required',
...
/* harmony import */ var _components_similar__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/similar */ "./src/js/components/similar.js");
/* harmony import */ var _components_product_card__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/product-card */ "./src/js/components/product-card.js");
